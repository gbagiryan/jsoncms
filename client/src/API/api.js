...
export const ObjApi = {
  ...
  async fetchAnObj (objId) {
    return await Axios.get(`${process.env.REACT_APP_SERVER_BASE_URL}/api/backoffice/getAnObj/${objId}`);
  },
  ...
  async getObjByTag (tags) {
    return await Axios.post(`${process.env.REACT_APP_SERVER_BASE_URL}/api/backoffice/getObjsByTag`, tags);
  }
};